...
import { Clock, AlertTriangle, CalendarDays, BookOpen, ChefHat, Package, Trash2, Truck, BarChart3, Cog, Warehouse, CheckSquare, ClipboardList, GitBranch, FlaskConical, Zap, MapPin, Layers, ShieldCheck } from 'lucide-react';
       ...
       <div className="flex-1 px-4 py-6 lg:px-8 max-w-6xl mx-auto w-full space-y-10">
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
            ...
            <button onClick={() => navigate('/tasks?tab=prep')} className="bg-card border border-border rounded-lg p-4 flex flex-col items-center gap-2 hover:border-primary/30 active:scale-95 transition-all">
