    ...
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        ...
        {schedules?.length > 0 ? (
          <div className="space-y-2">
            {schedules.map((shift) => (
              <div key={shift.id} className="p-3 rounded-lg bg-card border border-border/40">
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-2 text-xs">
          <div className="p-2 rounded-lg bg-card border border-border/40 flex items-center justify-between">
