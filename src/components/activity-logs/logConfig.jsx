...
export const LOG_TYPES = {
  temperature:    { label: "Temp Log",      icon: Thermometer,          color: "text-cyan-400",    bg: "bg-cyan-500/15",    border: "border-l-cyan-500",    dot: "bg-cyan-500",    badge: "bg-cyan-500/20 text-cyan-300 border-cyan-500/30",    routePath: "/logs?type=temperature" },
  bathroom:       { label: "Bathroom",       icon: Droplets,             color: "text-purple-400",  bg: "bg-purple-500/15",  border: "border-l-purple-500",  dot: "bg-purple-500",  badge: "bg-purple-500/20 text-purple-300 border-purple-500/30", routePath: "/logs?type=bathroom" },
  maintenance:    { label: "Maintenance",    icon: Wrench,               color: "text-amber-400",   bg: "bg-amber-400/15",   border: "border-l-amber-400",   dot: "bg-amber-400",   badge: "bg-amber-400/20 text-amber-300 border-amber-400/30",   routePath: "/logs?type=maintenance" },
  incident:       { label: "Incident",       icon: ShieldAlert,          color: "text-red-400",     bg: "bg-red-500/15",     border: "border-l-red-500",     dot: "bg-red-500",     badge: "bg-red-500/20 text-red-300 border-red-500/30",        routePath: "/logs?type=incident" },
  ...
  food_safety:    { label: "Food Safety",    icon: ClipboardCheck,       color: "text-teal-400",    bg: "bg-teal-500/15",    border: "border-l-teal-500",    dot: "bg-teal-500",    badge: "bg-teal-500/20 text-teal-300 border-teal-500/30",     routePath: "/logs?type=temperature" },
  ...
  waste:          { label: "Waste",          icon: Flame,                color: "text-yellow-500",  bg: "bg-yellow-600/15",  border: "border-l-yellow-600",  dot: "bg-yellow-600",  badge: "bg-yellow-600/20 text-yellow-400 border-yellow-600/30", routePath: "/logs?type=waste" },
  eighty_six:     { label: "86'd",           icon: Utensils,             color: "text-orange-500",  bg: "bg-orange-600/15",  border: "border-l-orange-600",  dot: "bg-orange-600",  badge: "bg-orange-600/20 text-orange-400 border-orange-600/30", routePath: "/logs?type=waste" },
  equipment:      { label: "Equipment",      icon: Wrench,               color: "text-sky-400",     bg: "bg-sky-500/15",     border: "border-l-sky-500",     dot: "bg-sky-500",     badge: "bg-sky-500/20 text-sky-300 border-sky-500/30",        routePath: "/logs?type=maintenance" },
  guest_complaint:{ label: "Guest Complaint",icon: MessageSquareWarning, color: "text-rose-400",    bg: "bg-rose-500/15",    border: "border-l-rose-500",    dot: "bg-rose-500",    badge: "bg-rose-500/20 text-rose-300 border-rose-500/30",     routePath: "/logs?type=incident" },
  ...
  issue:          { label: "Issue",          icon: AlertTriangle,        color: "text-red-400",     bg: "bg-red-500/15",     border: "border-l-red-500",     dot: "bg-red-500",     badge: "bg-red-500/20 text-red-300 border-red-500/30",        routePath: "/logs?type=incident" },
