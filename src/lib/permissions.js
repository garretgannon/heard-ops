...
export const PERMISSIONS = {
  ...
  VIEW_STATION_READINESS:   'view_station_readiness',
...
export const PERMISSION_LABELS = {
  ...
  view_comms:              'View Comms & Announcements',
  view_station_readiness:  'View Station Readiness',
...
export const PERMISSION_GROUPS = [
  {
    label: 'Navigation',
    keys: ['view_dashboard', 'view_pulse', 'view_logs', 'view_comms', 'view_team', 'view_knowledge'],
  },
  {
  ...
  {
    label: 'Operations',
    keys: ['complete_tasks', 'edit_prep_lists', 'view_inventory', 'view_beos', 'view_station_readiness'],
  },
  {
  ...
  {
    label: 'Management',
    keys: ['view_schedule', 'view_reports', 'view_vendors', 'manage_users', 'manage_settings'],
  },
];
...
export const DEFAULT_ROLE_PERMISSIONS = {
  ...
  general_manager: {
    ...
    view_schedule: true, view_reports: true, view_inventory: true,
    ...
    view_comms: true, view_station_readiness: true,
  ...
  kitchen_lead: {
    ...
    view_schedule: false, view_reports: false, view_inventory: true,
  ...
  cook: {
    view_dashboard: true, view_pulse: false, view_logs: true, submit_logs: true,
    approve_logs: false, view_private_logs: false, view_team: false, manage_users: false,
    view_schedule: false, view_reports: false, view_inventory: false,
  ...
  server: {
    ...
    view_templates: false, manage_templates: false, view_knowledge: true,
    view_comms: true, view_station_readiness: false,
