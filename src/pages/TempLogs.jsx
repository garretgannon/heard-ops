  ...
  return (
    <div className="pb-24">
      <div className="bg-card border-b border-border p-4 sticky top-0 z-10 flex items-center justify-between">
        ...
        {isAdmin && (
          <button
            onClick={() => navigate('/temp-log-templates')}
      ...
      <div className="px-4 py-8 text-center text-secondary-text">
        <p className="text-sm">Daily temperature log tasks will appear here</p>
        <p className="text-xs mt-2 text-muted-foreground">Create templates to auto-generate daily checks</p>
      </div>
    </div>
  );
}
