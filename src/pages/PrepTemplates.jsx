...
export default function PrepTemplates() {
  ...
  const handleEdit = (id) => {
    navigate(`/prep-templates/${id}/edit`);
  };
  ...
  return (
    <div className="pb-24">
      <div className="bg-card border-b border-border p-4 sticky top-0 z-10">
        <h1 className="text-lg font-bold text-foreground mb-3">Prep Templates</h1>
      ...
      <button
        onClick={() => navigate('/prep-templates/new')}
