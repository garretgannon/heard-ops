...
export default function OpeningChecklist() {
  ...
  return (
    <div className="mx-auto w-full max-w-[420px] flex flex-col gap-2.5 pb-24">
      ...
      <BottomSheet open={sheetOpen} onClose={() => setSheetOpen(false)} title="Add Opening Task">
          <div className="space-y-3">
            ...
            <button onClick={handleAdd} disabled={saving || !form.task_name.trim()}
              className="w-full h-12 bg-[#F5A623] text-black font-bold rounded-xl text-[14px] disabled:opacity-50 active:scale-95 transition-transform">
